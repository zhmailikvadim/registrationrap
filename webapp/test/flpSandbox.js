		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Registration Rap",
									"targetURL": "#registrationrap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"registrationrap-display": {
								"semanticObject": "registrationrap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=registrationrap",
									"url": sap.ui.require.toUrl("registrationrap")
								}
							}
						}
					}
